...
const sampleReview = {
  ...
  review_scope: "Review the v3.8.0 controlled permission execution authorization draft candidate for clarity, source identity preservation, founder posture id preservation, question handoff integrity, and boundary strength. This review is not permission grant, not authorization approval, not execution, and cannot promote, store, change canonical records, migrate, create accounts, use secrets, publish public release, or launch production.",
  review_language: "Review result: the v3.8.0 controlled draft candidate can move only to the controlled permission execution authorization review decision gate re-entry. Permission grant remains closed, authorization approval remains closed, execution remains closed, and no system may run from this review.",
  review_notes: "The question handoff and source identity stay intact: founder posture id, review decision id, draft review id, draft gate id, review route, founder question, permission question, source ids, and authority flag audit match the v3.8.0 controlled draft packet.",
  review_evidence_summary: "The v3.8.0 controlled draft packet exposes the v3.7.9 founder posture id, review decision id, draft review id, draft gate id, authorization review id, preflight id, hold id, source answer id, source record id, source family, review route, founder question, permission question, authority flag audit, rollback, monitoring, stop condition, expiry, and production boundary before review-decision readiness.",
  risk_review: "Risk remains: v3.8.0 controlled draft mismatch, v3.7.9 founder posture id mismatch, review decision id mismatch, draft review gate id mismatch, draft gate id mismatch, review route mismatch, founder question mismatch, permission question mismatch, authority flag audit mismatch, founder decision mismatch, authorization review mismatch, preflight mismatch, hold mismatch, source mismatch, rights change, ambiguous review language, rollback missing, monitoring missing, packet mutation, code change, or any true permission, authorization, execution, storage, canonical, public release, or production flag must block movement.",
  rollback_review: "Rollback review passes only when before_hash, v3.8.0 draft audit, v3.7.9 founder posture audit, draft-review audit, question handoff audit, source identity audit, and failure review remain visible and no source state is written.",
  monitoring_review: "Monitoring review keeps audit receipt, stop condition, failure review, reviewer handoff, v3.7.9 founder posture id, source identity, authority flag audit, and before-write check visible before any controlled review decision gate.",
  stop_condition: "Stop if the v3.8.0 draft gate id mismatches, v3.7.9 founder posture id mismatches, review decision id mismatches, draft review gate id mismatches, review route mismatches, founder question mismatches, permission question mismatches, authority flag audit mismatches, founder decision id mismatches, authorization review id mismatches, preflight id mismatches, hold id mismatches, source ids mismatch, rights change, review language is ambiguous, rollback is missing, monitoring is missing, code changes, packet text mutates, or any permission, authorization, execution, storage, canonical, public release, or production flag is true.",
  expiry_check: "Controlled permission execution authorization draft review gate re-entry expires at the next material v3.8.0 controlled draft, v3.7.9 founder posture, review decision, draft, source, rights, rollback, monitoring, packet, or code change and must be rechecked; not permission, not authorization, and not execution.",
  clarification_question: "Which exact v3.8.0 controlled draft packet should this review carry forward, and which single authority boundary should remain most visible?",
  return_reason: "Return if the v3.8.0 controlled draft packet loses route, question, audit, founder posture id, or source identity clarity.",
  hold_reason: "Hold until the reviewer can see the exact v3.8.0 controlled draft packet, source ids, route, questions, founder posture id, and authority audit.",
  block_reason: "Block if any authority flag becomes true or the v3.8.0 handoff is changed.",
...
const reviewGate = {
  ...
  summary: "Re-enters the controlled draft review gate from the v3.8.0 controlled draft packet, verifies source identity, founder posture id, route, questions, and authority audit, and prepares only controlled review-decision candidate language while every permission, authorization, execution, storage, public release, and production path remains disabled.",
  previous_release: "v3.8.0 Controlled Permission Execution Authorization Draft Gate Re-entry",
  source_release: "v3.8.0 Controlled Permission Execution Authorization Draft Gate Re-entry",
  next_gate: "Controlled permission execution authorization review decision gate re-entry",
  source,
  review_checks: [
    { check: "Input packet", rule: "Starts only from the v3.8.0 controlled draft candidate output." },
...
replaceAll("assets/vedapath-command-shell.js", [
  ['const releaseBadge = "v3.8.0 draft";', 'const releaseBadge = "v3.8.1 review";']
]);

appendIfMissing(
  "assets/vedapath-controlled-permission-execution-authorization-draft-review-gate.css",
  "VEDAPATH v3.8.1 CONTROLLED DRAFT REVIEW GATE RE-ENTRY",
  `
/* VEDAPATH v3.8.1 CONTROLLED DRAFT REVIEW GATE RE-ENTRY */
...
replaceAll("build-status.html", [
  ["v3.8.0 draft", "v3.8.1 review"],
  ["<strong>v3.8.0</strong>\n          <p>Controlled Permission Execution Authorization Draft Gate Re-entry: the draft gate now receives the v3.7.9 founder posture packet and prepares one draft-review candidate while every authority flag stays false.</p>", "<strong>v3.8.1</strong>\n          <p>Controlled Permission Execution Authorization Draft Review Gate Re-entry: the review gate now receives the v3.8.0 controlled draft packet and prepares one review-decision candidate while every authority flag stays false.</p>"],
  ["The trust chain now carries the v3.7.9 founder posture into controlled draft language without turning readiness into permission, authorization, execution, storage, public release, or production.", "The trust chain now reviews the v3.8.0 controlled draft packet without turning readiness into permission, authorization, execution, storage, public release, or production."],
  ["<strong>Controlled permission execution authorization draft review gate re-entry</strong>\n          <p>Review the v3.8.0 controlled draft packet before any later authorization posture while every authority flag remains false.</p>", "<strong>Controlled permission execution authorization review decision gate re-entry</strong>\n          <p>Route the v3.8.1 draft-review packet to review decision, hold, return, or block while every authority flag remains false.</p>"]
]);

const phase341Old = `            <article class="phase">
              <span class="badge later">Later</span>
              <div>
                <strong>Phase 341: Controlled Permission Execution Authorization Draft Review Gate Re-entry</strong>
                <p>Review the v3.8.0 controlled draft packet before any later authorization posture while every authority and production flag remains false.</p>
              </div>
              <div class="percent">0%</div>
            </article>`;

const phase341New = `            <article class="phase">
            ...
            <article class="phase">
              <span class="badge later">Later</span>
              <div>
                <strong>Phase 342: Controlled Permission Execution Authorization Review Decision Gate Re-entry</strong>
                <p>Route the v3.8.1 draft-review packet to founder decision, hold, return, or block while every authority and production flag remains false.</p>
              </div>
              <div class="percent">0%</div>
            </article>`;
replaceOnce("build-status.html", phase341Old, phase341New);

replaceAll("build-status.html", [
  ["<div class=\"version-row\"><span>Release</span><strong>v3.8.0 Controlled Permission Execution Authorization Draft Gate Re-entry</strong></div>", "<div class=\"version-row\"><span>Release</span><strong>v3.8.1 Controlled Permission Execution Authorization Draft Review Gate Re-entry</strong></div>"],
  ["<div class=\"version-row\"><span>Previous</span><strong>v3.7.9 Founder Permission Execution Authorization Decision Gate Re-entry</strong></div>", "<div class=\"version-row\"><span>Previous</span><strong>v3.8.0 Controlled Permission Execution Authorization Draft Gate Re-entry</strong></div>"],
  ["<div class=\"version-row\"><span>Goal</span><strong>Prepare controlled draft-review candidate language from the v3.7.9 founder posture packet without granting permission, approving authorization, or enabling execution.</strong></div>", "<div class=\"version-row\"><span>Goal</span><strong>Review the v3.8.0 controlled draft packet and prepare one review-decision candidate without granting permission, approving authorization, or enabling execution.</strong></div>"],
...
`;
replaceOnce("README.md", "## v3.8.0 Controlled Permission Execution Authorization Draft Gate Re-entry", `${readmeEntry}## v3.8.0 Controlled Permission Execution Authorization Draft Gate Re-entry`);

const protoEntry = `## v3.8.1 Controlled Permission Execution Authorization Draft Review Gate Re-entry
...
`;
replaceOnce("docs/PROTOTYPE_NOTES.md", "## v3.8.0 Controlled Permission Execution Authorization Draft Gate Re-entry", `${protoEntry}## v3.8.0 Controlled Permission Execution Authorization Draft Gate Re-entry`);
...
Controlled Permission Execution Authorization Draft Review Gate Re-entry accepts the v3.8.0 controlled draft packet and turns it into controlled review-decision candidate language only.

## What This Release Does

- Requires schema \`controlled-permission-execution-authorization-draft-gate-v6\`.
- Requires release \`v3.8.0\`.
...
- Receives the v3.8.0 controlled draft packet produced from the v3.7.9 founder posture.
...
The v3.7.7 re-entry accepted the v3.7.6 controlled draft packet. v3.8.1 advances the same gate pattern to the current v3.8.0 draft packet without opening authority.
