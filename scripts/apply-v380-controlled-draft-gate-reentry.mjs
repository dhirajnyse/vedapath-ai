...
const inputRelease = "v3.7.9";
const releaseBadge = "v3.8.0 draft";
const releaseName = "Controlled Permission Execution Authorization Draft Gate Re-entry";
const previousRelease = "v3.7.9 Founder Permission Execution Authorization Decision Gate Re-entry";
...
draftData.draft_checks = [
  { check: "Input packet", rule: "Must be the v3.7.9 draft-only founder posture packet." },
...
draftData.sample_draft = {
  ...
  ...sourceFields,
  draft_scope: "Prepare reviewable wording for the v3.7.9 founder posture packet only. The draft can be inspected by the next review gate, but it cannot grant permission, approve authorization, execute, store, update canonical records, publish, launch, or run any production path.",
  draft_language: "Controlled draft-review candidate for the v3.7.9 founder posture packet: preserve the reviewed source ids, route, founder question, permission question, and authority audit. The draft is only language for review. It does not open execution, storage, canonical writes, public release, or production.",
  draft_rationale: "The v3.7.9 founder posture is draft-only and source-locked. It can become reviewable language because the question handoff, source ids, founder posture id, and authority flag audit are intact. This is not a live authorization; it is only a controlled draft candidate for the next draft review gate.",
  draft_evidence_summary: "Input release v3.7.9 has founder_permission_execution_authorization_decision_ready=true, founder_permission_execution_authorization_decision_recorded=true, controlled draft candidate ready=true, the authority flag audit preserved, and every authority, execution, storage, canonical, public release, and production flag false.",
  non_execution_draft_clause: draftClause,
  risk_acknowledgment: "Risk remains: v3.7.9 founder posture mismatch, founder posture id mismatch, review decision id mismatch, draft review id mismatch, draft gate id mismatch, review route mismatch, founder question mismatch, permission question mismatch, authority flag audit mismatch, source id mismatch, rights change, ambiguous draft language, rollback missing, monitoring missing, packet mutation, code change, or any true permission, authorization, execution, storage, canonical, public release, or production flag must block movement.",
  rollback_condition: "Rollback by returning to the v3.7.9 founder decision gate and requiring a fresh non-authorizing founder posture before any draft-review candidate is prepared again.",
  monitoring_condition: "Monitor only the frozen v3.7.9 founder posture id, route, questions, source ids, authority audit, and false authority flags before preparing the controlled draft review candidate.",
  stop_condition: "Stop if the v3.7.9 founder posture id, founder decision id, review decision gate id, draft review gate id, draft gate id, review route, founder question, permission question, authority flag audit, source ids, rights, rollback, monitoring, packet text, or code changes, or if any permission, authorization, execution, storage, canonical, public release, or production flag is true.",
  expiry_check: "Controlled permission execution authorization draft gate re-entry expires at the next material v3.7.9 founder posture, review decision, draft review, draft, source, rights, rollback, monitoring, packet, or code change and must be rechecked; not permission, not authorization, and not execution.",
  ...
  next_gate: nextGate,
  clarification_question: "Which exact v3.7.9 founder posture packet should this draft-review candidate carry, and which single draft boundary should remain most visible?",
  return_reason: "Return if the v3.7.9 founder posture packet loses route, question, audit, founder posture id, or source identity clarity.",
  hold_reason: "Hold until the reviewer can see the exact v3.7.9 founder posture packet, source ids, route, questions, and authority audit.",
  block_reason: "Block if any authority flag becomes true or the v3.7.9 handoff is changed.",
  release
};
draftData.boundary = {
  ...draftData.boundary,
...
js = replaceAll(js, [
  ...
  ['packet.release === "v3.7.5"', 'packet.release === "v3.7.9"'],
  ["the v3.7.5 draft-only, non-authorizing posture packet", "the v3.7.9 draft-only, non-authorizing posture packet"],
  ["preserve the v3.7.5 source ids", "preserve the v3.7.9 source ids"],
  ['compact(draft.draft_scope).includes("v3.7.5")', 'compact(draft.draft_scope).includes("v3.7.9")'],
  ['[["v3.7.5"], ["question handoff"]', '[["v3.7.9"], ["question handoff"]'],
  ["the v3.7.5 handoff", "the v3.7.9 handoff"],
  ['{ label: "Input", value: "v3.7.5 founder posture" }', '{ label: "Input", value: "v3.7.9 founder posture" }']
]);
write(jsFile, js);
...
html = replaceAll(html, [
  ...
  ["the v3.7.5 founder posture", "the v3.7.9 founder posture"],
  ["v3.7.5 founder posture", "v3.7.9 founder posture"],
  ["VedaPath now carries the v3.7.5 founder posture", "VedaPath now carries the v3.7.9 founder posture"],
  ["<strong>v3.7.5 founder posture</strong>", "<strong>v3.7.9 founder posture</strong>"],
...
const cssMarker = "/* VEDAPATH v3.8.0 CONTROLLED DRAFT GATE RE-ENTRY */";
...
build = replaceAll(build, [
  ['<span class="version">v3.7.9 founder</span>', `<span class="version">${releaseBadge}</span>`],
  ["<strong>v3.7.9</strong>\n          <p>Founder Permission Execution Authorization Decision Gate Re-entry: the founder gate now receives the v3.7.8 review-decision packet and records draft-only, hold, return, or reject posture while every authority flag stays false.</p>", `<strong>${release}</strong>\n          <p>Controlled Permission Execution Authorization Draft Gate Re-entry: the draft gate now receives the v3.7.9 founder posture packet and prepares one draft-review candidate while every authority flag stays false.</p>`],
  ["The trust chain now carries the v3.7.8 review-decision packet into founder posture without turning readiness into permission, authorization, execution, storage, public release, or production.", "The trust chain now carries the v3.7.9 founder posture into controlled draft language without turning readiness into permission, authorization, execution, storage, public release, or production."],
  ["<strong>Controlled permission execution authorization draft gate re-entry</strong>\n          <p>Use the founder posture packet to prepare controlled draft language while every execution path remains closed.</p>", "<strong>Controlled permission execution authorization draft review gate re-entry</strong>\n          <p>Review the v3.8.0 controlled draft packet before any later authorization posture while every authority flag remains false.</p>"]
]);
build = replaceOnce(
  build,
  `<article class="phase">
...
build = replaceAll(build, [
  ["v3.7.9 Founder Permission Execution Authorization Decision Gate Re-entry", `${release} ${releaseName}`],
  ["v3.7.8 Controlled Permission Execution Authorization Review Decision Gate Re-entry", previousRelease],
  ["Record founder posture from the v3.7.8 review-decision packet without granting permission, approving authorization, or enabling execution.", "Prepare controlled draft-review candidate language from the v3.7.9 founder posture packet without granting permission, approving authorization, or enabling execution."],
  ["Ready for controlled draft gate re-entry", "Ready for controlled draft review gate re-entry"],
  ["Receive the v3.7.9 founder posture packet without granting authorization or execution.", "Receive the v3.8.0 controlled draft packet without granting authorization or execution."],
...
readme = insertBefore(readme, "## v3.7.9 Founder Permission Execution Authorization Decision Gate Re-entry", readmeBlock, "README v3.7.9");
...
notes = insertBefore(notes, "## v3.7.9 Founder Permission Execution Authorization Decision Gate Re-entry", notesBlock, "prototype notes v3.7.9");
write(notesFile, notes);

const blueprintBlock = `### 358. Controlled Permission Execution Authorization Draft Gate Re-entry
...
Controlled Permission Execution Authorization Draft Gate Re-entry accepts the v3.7.9 founder posture packet and turns it into draft-review candidate language only.
