(function () {
  ...
  function founderPermissionExecutionAuthorizationDecisionGate(config, reviewPacket, decision) {
    if (!reviewDecisionPacketReady(reviewPacket)) {
      return blocked("Blocked: review decision packet must be the v3.7.0 non-authorizing decision packet.", {
    ...
    if (!matchesReviewCarry(reviewPacket, decision)) {
      return blocked("Blocked: founder decision must preserve the v3.7.0 route, questions, source ids, founder posture id, and authority audit.", {
    ...
    if (!hasText(decision.decision_rationale, [["v3.7.0"], ["question handoff"], ["authority flag audit"], ["source ids"], ["founder posture id"], ["draft gate"], ["not a live authorization"]])) {
      return blocked("Blocked: decision rationale must explain the v3.7.0 handoff, founder posture id, source ids, authority audit, and non-authorization boundary.", {});
    }
  ...
  function loadConfig(config) {
    ...
    renderList("founderDecisionScope", [
      { label: "Input", value: "v3.7.0 review decision" },
