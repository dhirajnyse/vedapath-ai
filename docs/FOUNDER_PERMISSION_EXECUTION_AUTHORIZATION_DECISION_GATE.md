...
Founder Permission Execution Authorization Decision Gate Re-entry receives the v3.7.0 controlled review-decision packet and records founder posture after review-decision readiness.
...
## v3.7.1 Re-entry Notes

- Accept only the v3.7.0 controlled review-decision packet as input.
...
- Preserve the v3.7.0 route, source ids, source family, questions, founder posture id, and authority audit.
