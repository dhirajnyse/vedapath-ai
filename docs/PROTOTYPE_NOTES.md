# v0.2.0 Prototype Notes

The v0.2.0 release turns the VedaPath AI homepage into a clickable product prototype.
...
v0.3.0 should add a structured source schema and the first 25 to 50 verified answer records.
