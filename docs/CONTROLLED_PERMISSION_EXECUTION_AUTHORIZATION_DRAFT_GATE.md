...
Controlled Permission Execution Authorization Draft Gate Re-entry accepts the v3.6.7 founder posture packet and turns it into draft-review candidate language only.

## What This Release Does

- Requires schema `founder-permission-execution-authorization-decision-gate-v5`.
- Requires release `v3.6.7`.
- Preserves the v3.6.7 founder posture gate id before any draft candidate can be prepared.
